...
// Unpack the velocity from R16G16_FLOAT
float3 UnpackUpscaledVelocity(packed_velocity_t Velocity)
{
    return float3(f16tof32(Velocity & 0xffff), f16tof32((Velocity >> 16) & 0xffff), 0.0f);
}
